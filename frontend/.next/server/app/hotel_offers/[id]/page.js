...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(68378);
    ...
    const tree = {
        ...
        {
        children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 23024, 23)), "/Users/flohop/WebstormProjects/check24-holiday-challenge/frontend/app/hotel_offers/[id]/page.tsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 27471, 23)), "/Users/flohop/WebstormProjects/check24-holiday-challenge/frontend/app/layout.tsx"],
          metadata: {
    ...
    const pages = ["/Users/flohop/WebstormProjects/check24-holiday-challenge/frontend/app/hotel_offers/[id]/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 90080))
...
module.exports = createProxy("/Users/flohop/WebstormProjects/check24-holiday-challenge/frontend/app/hotel_offers/[id]/page.tsx");
...
/* harmony import */ var _apollo_client__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26174);
...
/* harmony import */ var _mui_material_Box__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(46661);
/* harmony import */ var _mui_material_Grid__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(89216);
...
/* harmony import */ var _mui_material_LinearProgress__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(54003);
/* harmony import */ var _mui_material_LinearProgress__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_mui_material_LinearProgress__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _mui_material_Rating__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(47022);
...
/* harmony import */ var _mui_material_Stack__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(5537);
/* harmony import */ var _mui_material_Typography__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(43360);
...
/* harmony import */ var react_infinite_scroller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48476);
...
/* harmony import */ var _app_components_HotelOffer_HotelOffer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(89748);
/* harmony import */ var _utils_mutations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(61116);
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(15705);
/* harmony import */ var react_cookie__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(15786);
...
const HOTEL_QUERY = _apollo_client__WEBPACK_IMPORTED_MODULE_6__.gql`
...
`;
const HOTEL_OFFERS_QUERY_2 = _apollo_client__WEBPACK_IMPORTED_MODULE_6__.gql`
...
function Page() {
    ...
    const [pageNumber, setPageNumber] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(1);
    const [canLoadMore, setCanLoadMore] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(true);
    const [offers, setOffers] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
    const router = (0,next_navigation__WEBPACK_IMPORTED_MODULE_1__.useRouter)();
    const [searchQuery, setSearchQuery] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)({});
    const [hotelId, setHotelId] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)();
    const [cookies, setCookie] = (0,react_cookie__WEBPACK_IMPORTED_MODULE_7__.useCookies)([
        "queryInput",
        "selected_hotelid"
    ]);
    const { data: hotelData , error: hotelError , loading: hotelLoading  } = (0,_apollo_client__WEBPACK_IMPORTED_MODULE_6__.useQuery)(HOTEL_QUERY, {
        variables: {
            "hotelId": hotelId
        }
    });
    const [getOffers, { data: offerData , error: offerError , loading: offerLoading , fetchMore  }] = (0,_apollo_client__WEBPACK_IMPORTED_MODULE_6__.useLazyQuery)(HOTEL_OFFERS_QUERY_2);
    ...
    const [toggleOfferMutation, { data: saveData , loading: saveLoading , error: saveError  }] = (0,_apollo_client__WEBPACK_IMPORTED_MODULE_6__.useMutation)(_utils_mutations__WEBPACK_IMPORTED_MODULE_5__/* .ADD_SAVED_OFFERS_MUTATION */ .m);
    (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(()=>{
    ...
    if (hotelError || hotelLoading) {
        return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_LinearProgress__WEBPACK_IMPORTED_MODULE_8___default()), {});
    }
    async function handleToggleOffer(offerId) {
        // Add offer mutation
        await toggleOfferMutation({
            variables: {
                offerId: offerId
            }
        });
                ...
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Grid__WEBPACK_IMPORTED_MODULE_9___default()), {
                        ...
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Typography__WEBPACK_IMPORTED_MODULE_10___default()), {
                            variant: "h4",
                            children: hotelData.hotel.hotelname
                        })
                    }),
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Grid__WEBPACK_IMPORTED_MODULE_9___default()), {
                        item: true,
                        xs: 1,
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_Rating__WEBPACK_IMPORTED_MODULE_11___default()), {
                            value: hotelData.hotel.hotelstars,
                            readOnly: true
                        })
                    })
                ]
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material_Box__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z, {
                display: "block",
                marginLeft: "auto",
                marginRight: "auto",
                sx: {
                    backgroundImage: `url("/hotels/${hotelData.hotel.hotelid % 40 + 1}.jpg")`,
                    width: "711px",
                    height: "400px",
                    backgroundSize: "cover"
                }
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_infinite_scroller__WEBPACK_IMPORTED_MODULE_3___default()), {
                pageStart: 1,
                loadMore: loadMore,
                hasMore: canLoadMore,
                threshold: 1000,
                loader: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_mui_material_LinearProgress__WEBPACK_IMPORTED_MODULE_8___default()), {}, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_13__/* .generateRandomNumber */ .H)()),
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material_Stack__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .ZP, {
                    gap: 3,
                    children: offerData !== undefined && offers.map((offer)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_app_components_HotelOffer_HotelOffer__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
                            ...
                            offer: {
                                ...
                                duration: (0,_utils_utils__WEBPACK_IMPORTED_MODULE_13__/* .calcDuration */ .L)(offer.outbounddeparturedatetime, offer.inboundarrivaldatetime)
                            }
                        }, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_13__/* .generateRandomNumber */ .H)()))
                })
            }, (0,_utils_utils__WEBPACK_IMPORTED_MODULE_13__/* .generateRandomNumber */ .H)())
        ]
    });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "H": () => (/* binding */ generateRandomNumber),
/* harmony export */   "L": () => (/* binding */ calcDuration)
/* harmony export */ });
...
var __webpack_exports__ = __webpack_require__.X(0, [848,136,22,476,645,926], () => (__webpack_exec__(23742)));
